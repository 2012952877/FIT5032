...
namespace FIT5032Assignment.Controllers
{
    ...
    {
        private AssignmentNewEntities db = new AssignmentNewEntities();
        ...
        public ActionResult Index()
        {
            ...
            var bookings = db.Bookings.Where(b => b.CustomerId == userId);
            return View(bookings.ToList());
        }

        // GET: Bookings/SelectKaraoke
        [Authorize]
        ...
        [ValidateInput(false)]
        [Authorize]
        public ActionResult Create([Bind(Include = "Date,Time,Until,Food_And_Drinks,Apply_For_Party,Leave_Message,CustomerId,KaraokeId")] Booking booking)
        {
