...
*/
const TOKEN = "pk.eyJ1IjoiZGNoZTAwNDUiLCJhIjoiY2sweDZ4cWNrMDNqdjNjcjVjeW1yaGltaiJ9.Z_HbsLbD79NHQrgcigiX_g";
var locations = [];
...
console.log([locations[0].longitude, locations[0].latitude]);
