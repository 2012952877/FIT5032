...
using FIT5032_Week05_CreatDateTable.Models;

namespace FIT5032_Week05_CreatDateTable.Controllers
{
    public class MOCK_DATAController : Controller
    {
        private FIT5032_Week05CreateDataTable_Models db = new FIT5032_Week05CreateDataTable_Models();
